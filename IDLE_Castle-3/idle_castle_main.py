...
x, y = 0, 0
music_files_europa = [
    ".\\music\\beethoven-moonlight-sonata-1-movement-op-27-nr-2.mp3",
    ".\\music\\Battotai - Imperial Japanese Army March.mp3",
]
...
def button_scenario(button_image, font1, text_color, screen):
    button_information = ImageButton(
        950,
        40,
        button_image,
        "Shoose",
